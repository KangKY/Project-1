...
public class MemoryPool : IEnumerable, System.IDisposable {
    ...
    //Vector3 spawnPosition_1 = new Vector3(10f, 4f, -1.0f);
    ...
    public void Create(Object original, int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            Item item = new Item();
            item.active = false;
            //item.gameObject = GameObject.Instantiate(original, spawnPosition_1, spawnRotation) as GameObject;
    ...
    public void RemoveItem(GameObject gameObject)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            {
                item.active = false;
                //item.gameObject.transform.position = spawnPosition_1;
                item.gameObject.SetActive(false);
                break;
            }
        }
