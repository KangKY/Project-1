...
namespace GamepadInput
{
    ...
    public static class GamePad
    {
        ...
        static KeyCode GetKeycode(Button button, Index controlIndex)
        {
            switch (controlIndex)
            {
                ...
                case Index.Two:
                    switch (button)
                    {
                        case Button.A: return KeyCode.Joystick2Button10;
                        case Button.B: return KeyCode.Joystick2Button9;
                        case Button.X: return KeyCode.Joystick2Button8;
                        case Button.Y: return KeyCode.Joystick2Button7;
                        case Button.RightShoulder: return KeyCode.Joystick2Button5;
                        case Button.LeftShoulder: return KeyCode.Joystick2Button6;
                        case Button.Back: return KeyCode.Joystick2Button1;
                        case Button.Start: return KeyCode.Joystick2Button0;
                        case Button.LeftStick: return KeyCode.Joystick2Button2;
                ...
                case Index.Three:
                    switch (button)
                    {
                        ...
                        case Button.RightShoulder: return KeyCode.Joystick2Button5;
                        case Button.LeftShoulder: return KeyCode.Joystick2Button6;
                        case Button.Back: return KeyCode.JoystickButton1;
        ...
        public static GamepadState GetState(Index controlIndex, bool raw = false)
        {
            ...
            state.Start = GetButtonDown(Button.Start, controlIndex);
            state.Back = GetButtonDown(Button.Back, controlIndex);
